...
export async function compactMangaOverview(
      ...
      .addFields(
         {
            ...
            value: textInline([
               ...
               [
                  {
                     step: `**Open on** ↬ [Anilist](${manga.siteUrl}) • [MyAnimeList](https://myanimelist.net/anime/${idMal})`,
                     spacing: 0,
                  },
               ],
            ]),
   ...
   return { embed, mediaTitle: manga.title, identifier: { idAl, idMal } };
}
